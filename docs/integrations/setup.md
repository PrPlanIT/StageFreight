...
|---|---|---|
| [**Build Runner**](gitlab/runner/docker/gitlab-runner-builds.md) | Builds and everything that isn't GitOps | DinD + BuildKit + the StageFreight cache |
| [**GitOps Runner**](gitlab/runner/docker/gitlab-runner-gitops-k8s.md) | GitOps / Kubernetes pipelines | DinD + docker-executor runner |
...
[`.stagefreight.yml`](../config/index.md).
