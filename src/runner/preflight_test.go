...
func TestInvocationID_LocalGeneratesHex(t *testing.T) {
	id := ResolveInvocationID(EngineLocal, RunnerIdentity{})
	if len(id) == 0 {
...
func TestInvocationID_LocalUniqueAcrossCalls(t *testing.T) {
	a := ResolveInvocationID(EngineLocal, RunnerIdentity{})
	b := ResolveInvocationID(EngineLocal, RunnerIdentity{})
...
func TestInvocationID_GitLabUsesPipelineID(t *testing.T) {
	id := ResolveInvocationID(EngineGitLab, RunnerIdentity{PipelineID: "9876"})
	if id != "9876" {
