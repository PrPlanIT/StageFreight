...
type CIConfig struct {
	...
	// Forge names the forge whose CI skeleton this repo runs on, and therefore which
	// pipeline file governance renders and distributes (gitlab → .gitlab-ci.yml,
	// github → .github/workflows/stagefreight.yml, …). More than one may be listed —
	// each writes its own file — for a repo genuinely wired to two CI systems.
	//
